...
BigscapeFunc.openFamDetail = function(id_fam, ids_highlighted, bs_svg, bs_data, bs_to_cl, bs_families, bs_similarity, det_ui) {
  ...
  if ((id_fam > -1) && (id_fam < bs_families.length)) {
    ...
    // make Ref BGC label bold and red for 'avl_in_Sav11' bgc
    treeSVG.find("g[idx='50'] text.arrower-label")
      .attr("font-weight", "bold")
      .attr("font-style", "italic")
      .attr("fill", "red");

    // make Ref BGC label bold and red. Uncoment below 4 lines for 'avs_in_Sav11' bgc
    //treeSVG.find("g[idx='51'] text.arrower-label")
      //.attr("font-weight", "bold")
      //.attr("font-style", "italic")
      //.attr("fill", "red");

    // make Ref BGC label bold and red. Uncoment below 4 lines for 'giant_NRPS_in_Sav17' bgc
    //treeSVG.find("g[idx='50'] text.arrower-label")
      //.attr("font-weight", "bold")
      //.attr("font-style", "italic")
      //.attr("fill", "red");

    // make Ref BGC label bold and red. Uncoment below 4 lines for 'Sar13' bgc
    //treeSVG.find("g[idx='62'] text.arrower-label")
      //.attr("font-weight", "bold")
      //.attr("font-style", "italic")
      //.attr("fill", "red");
